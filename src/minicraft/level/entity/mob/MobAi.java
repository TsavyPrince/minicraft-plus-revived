...
public abstract class MobAi extends Mob {
	...
	public void doHurt(int damage, Direction attackDir) {
		...
		level.addEntity(new TextParticle("" + damage, x, y, Color.RED)); // Make a text particle at this position in this level, bright red and displaying the damage inflicted
